...
export const metadata: Metadata = {
  ...
  description: "North Lantern Group designs and improves Atlassian, business intelligence, and automation systems so teams can see the work clearly, own it internally, and scale without piling on manual effort.",
  alternates: {
